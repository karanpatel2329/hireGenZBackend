...
router.post("/editRecruiterProfile",recruiterMiddleware,recruiterController.editRecruiterProfile);
router.post("/addRecruiterCompany",recruiterMiddleware,recruiterController.addRecruiterCompany);
router.post("/editRecruiterCompany",recruiterMiddleware,recruiterController.editRecruiterCompany);
...
router.get("/getAllPostedJob",recruiterMiddleware,recruiterController.getAllJobByRecruiterId);
router.get("/getAllShortlisted",recruiterMiddleware,recruiterController.getAllShortlisted);
